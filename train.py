...
def compute_gate_losses(aux_outputs, disease_mask, false_healthy_mask, has_false_healthy, lambda_fh):
    ...
    for stage_name in ('hlg_stage3', 'hlg_stage4'):
        ...
        gate_loss = gate_loss + loss_dis_i + lambda_fh * loss_fh_i
...
def train_one_epoch(model, criterion_fn, optimizer, data_loader, lr_scheduler, epoch, print_freq,
    ...
    for data in metric_logger.log_every(data_loader, print_freq, header):
        ...
        gate_losses = compute_gate_losses(aux_outputs, target, false_healthy_mask, has_false_healthy, args.lambda_fh)
        loss = seg_loss + args.lambda_gate * gate_losses['gate_loss']
